        ...
        <ul>
          ...
          <li
            ...
            <a class="flex items-center gap-[10px] text-light dark:text-white/60 font-normal text-[15px]
                group-hover:text-primary" (click)="toggleDropdown()">
              <span class="[&>svg]:w-[14px] [&>svg]:h-[14px]" nz-icon nzType="plus" nzTheme="outline"></span>
               Add New Label 
            </a>
            <div class="absolute w-full top-0 start-1/2 -translate-x-1/2 bg-white dark:bg-[#1b1b28] w-[calc(100% + 60px)] px-[30px] py-[25px] rounded-lg shadow-boxLarge dark:shadow-[0_5px_30px_rgba(1,4,19,.60)] invisible opacity-0 [&.show]:visible [&.show]:opacity-100" [ngClass]="{'show': isDropdownOpen}">
                <form>
                  ...
                  <div class="flex items-center flex-wrap mt-[10px] -mx-[5px] -mb-[5px]">
                    ...
                    <button type="button"
                      class="bg-transparent hover:bg-primary hover:border-primary border-regular dark:border-white/10 dark:text-white/[.87] text-dark hover:text-white h-[38px] m-[5px] px-5 text-sm font-semibold rounded" (click)="closeDropdown()">
                      <span>Cancel</span>
                    </button>
                  </div>
                </form>
...
<div
  [ngClass]="isClassA ? 'fixed bg-white dark:bg-[#212e3d] w-full rounded-[10px] shadow-[0_10px_50px_rgba(146,153,184,.19)] dark:shadow-[0_5px_30px_rgba(1,4,19,.60)] md:max-w-[600px] max-md:max-w-[400px] max-ssm:max-w-[240px] end-[15px] z-[9998] bottom-[5%]' : 'fixed bg-white dark:bg-[#212e3d] w-full rounded-[10px] shadow-[0_10px_50px_rgba(146,153,184,.19)] dark:shadow-[0_5px_30px_rgba(1,4,19,.60)] max-w-[1200px] end-[0] z-[9998] bottom-[5%] '"
  *ngIf="isCompose">
  <div
